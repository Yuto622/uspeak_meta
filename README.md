...
100匹の見た目が、いただいた**本物の絵**になりました（`client/dist/assets/fish/`・69しゅるい）。
図鑑のカード、持ち物の行、水槽の欄、ぜんぶ写真です。

| 釣り場 | しゅるい | 例 |
|---|---|---|
| こもれび池（5級・4級） | 17 | メダカ・コイ・ベタ・ブルーギル・ブラックバス・フナ・ディスカス・ネオンテトラ・ザリガニ・カエル・みずうみの ぬし |
| せせらぎ川（3級） | 12 | ニジマス・サクラマス・サケ・ナマズ・ウナギ・ウグイ・にじの マス・こがねの さかな |
| 星海の桟橋（準2級・2級） | 47 | マグロ・カツオ・タイ・サメ・シャチ・イルカ・フグ・チンアナゴ・チョウチンアンコウ・リュウグウノツカイ ほか |
| どこでも | 4 | ながぐつ・ボトルメール・たからばこ（1つの釣り場で1回だけ） |

- **枠は100のまま、ことばも100語のままです。** 子どものセーブ（図鑑・持ち物）は
  そのまま引き継がれます。
- しゅるいが枠より少ない釣り場では、同じ写真が2〜3回出ます。名前は
  **メダカ／オオメダカ／ヒメメダカ** のように大きさで分けていて、**100匹ぜんぶ名前が違います**。
- 写真は69枚で **0.73MB**。図鑑を開いたときに、見えているカードのぶんだけ落ちます。
