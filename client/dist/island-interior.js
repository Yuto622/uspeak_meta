...
export function createIslandInteriors({ player, camera, toast }) {
  ...
  const DRESSING = {
    ...
    // 英検の島の4館. Each one is the skill it teaches, so a child who walks in knows
    // what is about to be asked of them before the screen opens.
    reading: [[-5, 1.3, -3, 2.2, 2.6, 1.2, 0x8d6642], [-5, 0.55, -3, 2.4, 0.24, 1.4, 0xf0e6cc],
      [-5, 1.35, -3, 2.4, 0.2, 1.4, 0xf0e6cc], [5, 1.3, -3, 2.2, 2.6, 1.2, 0x8d6642],
      [5, 0.55, -3, 2.4, 0.24, 1.4, 0xf0e6cc], [0, 0.4, 3.4, 3.4, 0.8, 2.2, 0xb8865a]],
    listening: [[-5.2, 1.5, -3.4, 1.8, 3, 1.4, 0x3f5566], [-5.2, 2.4, -4.1, 1.2, 1.1, 0.2, 0xd9e6ee],
      [5.2, 1.5, -3.4, 1.8, 3, 1.4, 0x3f5566], [5.2, 2.4, -4.1, 1.2, 1.1, 0.2, 0xd9e6ee],
      [0, 0.35, 2.6, 4.4, 0.7, 3, 0x6f8a9a]],
    writing: [[-4.8, 2.6, -3.2, 0.7, 5, 0.7, 0xf0c05a], [-4.8, 5.3, -3.2, 0.8, 0.6, 0.8, 0xe8a8a0],
      [4.8, 0.7, -3.2, 1.8, 1.4, 1.8, 0x2f3a44], [0, 0.45, 2.8, 3.6, 0.9, 2.4, 0xb9a77f],
      [0, 0.95, 2.8, 2.6, 0.1, 1.8, 0xfaf3e2]],
    // おはなし島のブース: two chairs facing each other and a low table. Nothing to press.
    booth: [[-2.2, 0.45, 0.4, 1.2, 0.9, 1.2, 0x8a6a4a], [-2.2, 1.1, -0.2, 1.3, 1.2, 0.26, 0x9a7a5a],
      [2.2, 0.45, 0.4, 1.2, 0.9, 1.2, 0x8a6a4a], [2.2, 1.1, 1, 1.3, 1.2, 0.26, 0x9a7a5a],
      [0, 0.42, 0.4, 2, 0.84, 1.6, 0xb9a77f], [0, 0.9, 0.4, 1.6, 0.14, 1.2, 0xd8c9a4],
      [0, 2.6, -6.6, 3, 1.2, 0.3, 0xf0a860]],
    speaking: [[0, 0.4, 2.4, 6, 0.8, 3.4, 0x7a6a58], [0, 1.35, 2, 0.2, 1.2, 0.2, 0x3d4a44],
      [0, 2.05, 2, 0.42, 0.36, 0.42, 0xd8d2c4], [-5.2, 1.6, -2.6, 1.4, 3.2, 1.2, 0x9a5f7a],
      [5.2, 1.6, -2.6, 1.4, 3.2, 1.2, 0x9a5f7a]],
  };
