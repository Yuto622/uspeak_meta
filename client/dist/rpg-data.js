...
export const HUBS=[{id:'willow',name:'U-Speak島',yomi:'ユースピークとう',en:'U-Speak Island',x:0,z:0,color:0x8da876,accent:0xddc891,hub:true,hint:'英会話クエスト、100種の英単語釣り、魚の買取・装備店。'},{id:'park',name:'テーマパーク',yomi:'てーまぱーく',en:'Wonder Park',x:135,z:0,color:0x799eaf,accent:0xe7c08d,hub:true,hint:'大観覧車・コースター・メリーゴーランドと夜の花火。'},{id:'errand',name:'おつかい島',yomi:'おつかいじま',en:'Errand Island',x:-150,z:75,color:0xd8b98a,accent:0xf2d9a0,hub:true,hint:'英語でおつかい。広場で受けて、お店で話して、届けてクリア。'},{id:'school',name:'ことばの学校島',yomi:'ことばのがっこうじま',en:'Word School Island',x:170,z:130,color:0x9cb46e,accent:0xe8c46a,hub:true,hint:'3つの小屋で10問クイズ。やさしい・ふつう・むずかしい。'},{id:'arena',name:'えいごアリーナ島',yomi:'えいごありーなじま',en:'Word Arena Island',x:-140,z:-110,color:0x9aa88f,accent:0xc9a3d4,hub:true,hint:'英語で答えて わざを出す バトル。らくらく・ふつう・つよい。'},{id:'pet',name:'ペット島',yomi:'ぺっとじま',en:'Pet Island',x:-30,z:250,color:0xa2bd85,accent:0xe8d4a0,hub:true,hint:'たまごから ペット。ごはんと なでなでで そだつ。'},{id:'ride',name:'のりもの島',yomi:'のりものじま',en:'Ride Island',x:210,z:-140,color:0x9ab27a,accent:0xd9c07a,hub:true,hint:'レベルとコインで のりものを 開放。6つの ことばの ゲートを 走る。'},{id:'town',name:'まちづくり島',yomi:'まちづくりじま',en:'Town Island',x:-210,z:-40,color:0x9fb488,accent:0xd8c39a,hub:true,hint:'ブロックを かって、じぶんの へやを つくる。ひろい へやに ひっこせる。'},{id:'eiken5',name:'英検5級の島',yomi:'えいけん5きゅうのしま',en:'Eiken 5 Island',x:-90,z:-290,color:0x9ec96a,accent:0xffd166,hub:true,hint:'英検5級の 4技能。読む・聞く・書く・話すの 4つの 館。'},{id:'eiken4',name:'英検4級の島',yomi:'えいけん4きゅうのしま',en:'Eiken 4 Island',x:0,z:-330,color:0x8fa858,accent:0xd98e3a,hub:true,hint:'英検4級の 4技能。過去形・未来形・くらべる 言い方。'},{id:'eiken3',name:'英検3級の島',yomi:'えいけん3きゅうのしま',en:'Eiken 3 Island',x:250,z:-280,color:0x6f8a70,accent:0x8ad8ff,hub:true,hint:'英検3級の 4技能。現在完了・受け身・関係代名詞。'},{id:'talk',name:'おはなし島',yomi:'おはなしじま',en:'Talk Island',x:80,z:200,color:0x8fbf86,accent:0xf0a860,hub:true,hint:'島そのものが おはなしの 部屋。ひろばに いる みんなと 顔を見て 話せる。'},{id:'conv',name:'英会話島',yomi:'えいかいわじま',en:'Conversation Island',x:-260,z:170,color:0xe4b07a,accent:0xf5b944,hub:true,hint:'ウーピーと 英語で おしゃべり。4つの 家で 場面べつに 話す。'},{id:'wear',name:'きせかえ島',yomi:'きせかえじま',en:'Dress-up Island',x:190,z:250,color:0xc9a0c4,accent:0xf2d3e0,hub:true,hint:'ぼうし・かお・せなか・むね。4つの お店で コインを つかって きがえる。'},{id:'mini',name:'ミニゲーム島',yomi:'みにげーむじま',en:'Minigame Island',x:120,z:-250,color:0x8fae9a,accent:0xf0c84a,hub:true,hint:'ふたつの 家に ふたつの ゲーム。ぷよと スイカで えいごを おぼえる。'}];
...
export const ACTIVITY_HUBS=new Set(['errand','school','arena','pet','ride','town','eiken5','eiken4','eiken3','talk','conv','wear','mini']);
