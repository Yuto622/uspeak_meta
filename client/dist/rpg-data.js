...
export const HUBS=[{id:'willow',name:'Willow Island',en:'WILLOW ISLAND',x:0,z:0,color:0x8da876,accent:0xddc891,hub:true,hint:'英会話クエスト、100種の英単語釣り、魚の買取・装備店。'},{id:'park',name:'U-Speak Roblox テーマパーク',en:'WONDER PARK',x:135,z:0,color:0x799eaf,accent:0xe7c08d,hub:true,hint:'大観覧車・コースター・メリーゴーランドと夜の花火。'},{id:'errand',name:'おつかい島',en:'ERRAND ISLAND',x:-150,z:75,color:0xd8b98a,accent:0xf2d9a0,hub:true,hint:'英語でおつかい。広場で受けて、お店で話して、届けてクリア。'},{id:'school',name:'ことばの学校島',en:'WORD SCHOOL',x:170,z:130,color:0x9cb46e,accent:0xe8c46a,hub:true,hint:'3つの小屋で10問クイズ。やさしい・ふつう・むずかしい。'},{id:'arena',name:'えいごアリーナ島',en:'WORD ARENA',x:-140,z:-110,color:0x9aa88f,accent:0xc9a3d4,hub:true,hint:'英語で答えて わざを出す バトル。らくらく・ふつう・つよい。'},{id:'pet',name:'ペット島',en:'PET ISLAND',x:-30,z:250,color:0xa2bd85,accent:0xe8d4a0,hub:true,hint:'たまごから ペット。ごはんと なでなでで そだつ。'},{id:'ride',name:'のりもの島',en:'RIDE ISLAND',x:210,z:-140,color:0x9ab27a,accent:0xd9c07a,hub:true,hint:'レベルとコインで のりものを 開放。6つの ことばの ゲートを 走る。'},{id:'town',name:'まちづくり島',en:'TOWN ISLAND',x:-210,z:-40,color:0x9fb488,accent:0xd8c39a,hub:true,hint:'ブロックを かって、じぶんの へやを つくる。ひろい へやに ひっこせる。'},{id:'eiken5',name:'英検5級の島',en:'EIKEN 5 · STARTER ISLE',x:-40,z:-250,color:0x9ec96a,accent:0xffd166,hub:true,hint:'英検5級の 4技能。読む・聞く・書く・話すの 4つの 館。'},{id:'eiken4',name:'英検4級の島',en:'EIKEN 4 · LEARNER ISLE',x:60,z:-300,color:0x8fa858,accent:0xd98e3a,hub:true,hint:'英検4級の 4技能。過去形・未来形・くらべる 言い方。'},{id:'eiken3',name:'英検3級の島',en:'EIKEN 3 · VOYAGER ISLE',x:160,z:-250,color:0x6f8a70,accent:0x8ad8ff,hub:true,hint:'英検3級の 4技能。現在完了・受け身・関係代名詞。'}];
