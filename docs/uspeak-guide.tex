...
入口は2つあります。\textbf{のりもの島に降りると、画面の左下にボタンが出ます}（写真の左下）。
\textbf{スタート・ゴールに立つと出るパネルの、いちばん上の扉}からも入れます。
...
\toprule
入口 & 島に降りた時点で\textbf{画面の左下のボタン}／スタート・ゴールのパネル \\
...
{\textbf{まちづくり島に降りると、画面の左下にボタンが出ます。}
島に建っている\textbf{「ブロックの とびら」という建物}に歩いて入っても同じです。
