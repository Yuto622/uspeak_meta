...
\begin{tikzpicture}[remember picture, overlay]
  ...
  \node[anchor=north] at ($(current page.north)+(0,-10.6)$)
    {\fboxsep=0pt\fboxrule=0pt\includegraphics[width=15.5cm]{island-willow.jpg}};
...
\shot{island-willow.jpg}{はじまりの島。桟橋で釣り、奥の道が10のRPG地域へ続く。}
...
\shot{island-errand.jpg}{おつかい島。10軒の店と広場。用事のある店に矢印が出る。}
...
\shot{island-school.jpg}{ことばの学校島。やさしい／ふつう／むずかしいの小屋と、奥にジム。}
...
\shot{island-arena.jpg}{えいごアリーナ島。3つの CPU 台と、たいせん台、おさかな道場。}
...
\shot{island-pet.jpg}{ペット島。たまごの巣、ごはん処、ふれあい広場。}
...
\shotw{0.68}{island-ride.jpg}{のりもの島。4つのゲートと、スタート・ゴールのライン。}
...
\shotaside{game-racers.jpg}{AURORA KART · Zenith Edition。全画面で始まる。}
{\textbf{スタート・ゴールに立つと出るパネルの、いちばん上の扉}から入ります。
島のレースとは別に作られた\textbf{まったく別のカートレース}で、コース4本・
グランプリ・タイムアタック・えいごモード、マシンも4台から選べます。

「← U-Speak」を押せば、立っていた場所に戻ります。
\textbf{コインも学習の記録も動きません}（正誤を判定しているのがそのゲーム自身のため）。}
...
\shotw{0.68}{island-town.jpg}{まちづくり島。ブロック屋、ふどうさん、かぐ屋、マイルーム入口、ブロックのとびら、ひろば。}
...
\shotaside{game-blockwild.jpg}{BLOCKWILD。「ブロックの とびら」に歩いて入ると始まる。}
{島に建っている\textbf{「ブロックの とびら」という建物}に歩いて入ります。
ブロックを積んで世界を作る、\textbf{まったく別のゲーム}です。

\textbf{ここが ブロック屋と つながっています。} クリエイティブで手に持てるのは、
\textbf{ブロック屋で U-Speak コインを払って買ったブロックだけ}。英語をやって
コインを稼ぐと、建てられるものが増えます。
...
\shot{island-eiken5.jpg}{英検5級の島。よむ図書館・きく音楽堂・かく工房・はなすステージ・めんせつの間。}
...
\shot{island-eiken3.jpg}{英検3級の島。島の色と地形が級ごとに違うので、どこにいるか一目でわかる。}
...
\shot{island-conv.jpg}{英会話島。であいのカフェ、おかいものストリート、がっこうテラス、ゆめのとうだい。}
...
\shot{island-talk.jpg}{おはなし島。おしゃべりブース、しずかなブース、はっぴょうルーム、せんせいルーム。}
...
\shot{island-wear.jpg}{きせかえ島。ぼうしや・めがねや・かばんや・アクセサリーや、そして広場の鏡。}
...
\shot{island-mini.jpg}{ミニゲーム島。左の家が PUYO U-SPEAK、右の家が えいご スイカゲーム。}
...
\shot{island-park.jpg}{テーマパーク。はじまりの島のゲートから入る。}
...
島の建物に入ると開く画面です。どれも\textbf{正誤をサーバーが決めて}います。

\subsection{ことばの学校島 と えいごアリーナ島}

\shothalf{screen-quiz.jpg}{単語クイズ。10問。難易度は入った小屋で決まる。}
\hfill
\shothalf{screen-battle.jpg}{バトル。正解がそのままダメージになる。}

\vspace{6pt}
クイズは4択、10問で1セット。答えると\textbf{その場で正解と意味が出て}、
まちがえた問題はあとでもう一度出ます。バトルは同じ出題を「攻撃」に置き換えたものです。
どちらも終わると XP とコインが入り、\textbf{何問中何問}が記録に残ります。

\subsection{英検の島}

\shothalf{screen-eiken.jpg}{英検・よむ。級と技能は建物で決まっている。}
\hfill
\shothalf{screen-interview.jpg}{めんせつの間。面接官はキャラクターの動画。}

\vspace{6pt}
英検の画面は級ごと・技能ごとに分かれています。\textbf{記録も級ごと}なので、
「5級の聞くは9割、書くは6割」という粒度で残ります。
面接は本番のかたち（カード・音読・質問・自分のこと）をそのままなぞります。

\clearpage

\subsection{AI英会話}

\shot{screen-conv.jpg}{英会話島。ウーピーと話す画面。英文と、日本語のヒント。}

声で話しても、打ち込んでもかまいません。返事は英語で、ヒントは日本語。
\textbf{1日に話せる分数には上限があります}（教室ごとに設定できます）。

\subsection{お店の画面}

\shothalf{screen-blockshop.jpg}{ブロック屋。10種のブロックが 3D のプレビューつきで並ぶ。}
\hfill
\shothalf{screen-wardrobe.jpg}{きせかえ。41点が、回る 3D のカードで並ぶ。}

\vspace{6pt}
どちらの店も、\textbf{買う前に 実物が見えます}。ブロックは立体のかたちと質感で、
きせかえは実際に回る 3D で。\textbf{どのブロックにも英単語がついています}
（wood / stone / brick / glass / sand / snow / lamp / flower / water / grass）。

\clearpage

\subsection{のりもののガレージ}

\shot{screen-garage.jpg}{のりもの島のガレージ。値段・必要レベル・足りないコインが出る。}

\textbf{買えないときは、なぜ買えないかが出ます。} 「あと \coin{}300」「あと Lv.2」のように、
足りないものが数字で出るので、次に何をすればよいかがわかります。
別のゲートの乗り物は「べつのゲート」と書かれ、\textbf{歩いて行くべき場所}が示されます。

\subsection{マイページ と 先生コンソール}
...
どれも全画面で始まり、「← U-Speak」で島に戻ります。

\shothalf{game-racers.jpg}{AURORA KART（のりもの島）。4コース・グランプリ・タイムアタック。}
\hfill
\shothalf{game-blockwild.jpg}{BLOCKWILD（まちづくり島・ブロックのとびら）。ブロックの世界。}

\vspace{4pt}

\shothalf{game-puyo.jpg}{PUYO U-SPEAK（ミニゲーム島・左の家）。}
\hfill
\shothalf{game-suika.jpg}{えいご スイカゲーム（ミニゲーム島・右の家）。}
